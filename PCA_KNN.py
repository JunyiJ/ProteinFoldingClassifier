...
if __name__=="__main__":	
	...
	if n != 2:
		...
		train_Xt = pca.fit_transform(train_X)
		test_Xt = pca.fit_transform(test_X)
		print train_Xt.shape
		print test_Xt.shape
		#Using cross validation to get a good k value
		neighbors = [x for x in range(1,15,2)]
		goodneighbor = cross_validation_k(train_Xt, train_Y, neighbors, join(data_path, "CV_pcaKNN_k"))
		...
		draw_ROC(train_Xt, train_Y, KNN, join(data_path,"ROC_pcaKNN"))
